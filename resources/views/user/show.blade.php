            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="md:w-1/2">
                        ...
                        <div class="mb-4 text-center">
                          <button data-micromodal-trigger="modal-1" href='javascript:;' type="button" class="text-white bg-gray-300 border-0 py-2 px-6 focus:outline-none hover:bg-gray-300 rounded">ショップの詳細を見る</button>
                        </div>
                    </div>
                </div>
            </div>
